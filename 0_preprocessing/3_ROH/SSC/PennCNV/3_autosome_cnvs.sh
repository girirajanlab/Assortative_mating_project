...
perl $PENNCNV_PATH/detect_cnv.pl -test -hmm $PENNCNV_PATH/lib/hhall.hmm -pfb Analysis_files/1Mv1.pfb --list Analysis_files/1Mv1_files.list -log logs/3_1mv1_autosome.log -out raw_out/1Mv1_autosome.txt
perl $PENNCNV_PATH/detect_cnv.pl -test -hmm $PENNCNV_PATH/lib/hhall.hmm -pfb Analysis_files/1Mv3.pfb --list Analysis_files/1Mv3_files.list -log logs/3_1mv3_autosome.log -out raw_out/1Mv3_autosome.txt
perl $PENNCNV_PATH/detect_cnv.pl -test -hmm $PENNCNV_PATH/lib/hhall.hmm -pfb Analysis_files/Omni2.5.pfb --list Analysis_files/Omni2.5_files.list -log logs/3_omni2.5_autosome.log -out raw_out/Omni2.5_autosome.txt
