...
df = pd.read_csv('intermediate_files/final/14_rare_deleterious_exonic_variants_cohort_count.csv')

print(df[df['Gene.wgEncodeGencodeBasicV38'].apply(lambda s: ';' in s)][['Func.wgEncodeGencodeBasicV38', 'Gene.wgEncodeGencodeBasicV38']])

### NEED TO GET v38 OF THIS FILE ###
...
df.to_csv('intermediate_files/final/15_rare_deleterious_exonic_variants_cohort_count_gene_ids.csv', index=False)
