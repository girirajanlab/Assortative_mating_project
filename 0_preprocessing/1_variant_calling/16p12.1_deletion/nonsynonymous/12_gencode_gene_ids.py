...
df = pd.read_csv('tables/11_rare_deleterious_exonic_variants_cohort_count.csv')
...
df.to_csv('tables/12_rare_deleterious_exonic_variants_cohort_count_gene_ids.csv', index=False)
