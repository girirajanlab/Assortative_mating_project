...
df = pd.read_csv('tables/12_rare_deleterious_exonic_variants_cohort_count_gene_ids.csv')
...
df.to_csv('tables/13_rare_deleterious_exonic_variants_cohort_count_gene_ids_loeuf.csv', index=False)
